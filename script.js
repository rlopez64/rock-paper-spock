...
rockImg.src = 'options/rock.png';

const paperImg = new Image();
paperImg.src = 'options/paper.png';

const scissorsImg = new Image();
scissorsImg.src = 'options/scissors.png';

const lizardImg = new Image();
lizardImg.src = 'options/lizard.jpg';

const spockImg = new Image();
spockImg.src = 'options/spock.jpg';
